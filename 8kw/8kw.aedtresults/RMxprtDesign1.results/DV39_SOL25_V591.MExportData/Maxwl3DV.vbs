...
oModule.AssignCoilTerminal Array("NAME:PhA_0", "Objects:=", Array("CoilTerm_0"), _
  "Conductor number:=", 19, "Point out of terminal:=", false, "Winding:=", _
  "PhaseA")
...
oModule.AssignCoilTerminal Array("NAME:PhBRe_2", "Objects:=", Array(_
  "CoilTerm_2"), "Conductor number:=", 19, "Point out of terminal:=", true, _
  "Winding:=", "PhaseB")
oModule.AssignCoilTerminal Array("NAME:PhCRe_3", "Objects:=", Array(_
  "CoilTerm_3"), "Conductor number:=", 19, "Point out of terminal:=", true, _
  "Winding:=", "PhaseC")
...
oModule.AssignCoilTerminal Array("NAME:PhARe_6", "Objects:=", Array(_
  "CoilTerm_6"), "Conductor number:=", 19, "Point out of terminal:=", true, _
  "Winding:=", "PhaseA")
oModule.AssignCoilTerminal Array("NAME:PhBRe_7", "Objects:=", Array(_
  "CoilTerm_7"), "Conductor number:=", 19, "Point out of terminal:=", true, _
  "Winding:=", "PhaseB")
...
oModule.AssignLengthOp Array("NAME:Length_Main", "RefineInside:=", true, _
  ...
  "RestrictLength:=", true, "MaxLength:=", "21.2mm")
oEditor.ChangeProperty Array("NAME:AllTabs", Array(_
