...
oModule.AssignWindingGroup Array("NAME:PhaseA", "Type:=", "Voltage", _
  ...
  "424.578 * sin(2*pi*133.333*time+17.3128*pi/180)", "ParallelBranchesNum:=", _
  "1")
Set oModule = oDesign.GetModule("BoundarySetup")
oModule.AssignWindingGroup Array("NAME:PhaseB", "Type:=", "Voltage", _
  "IsSolid:=", false, "Current:=", "0A", "Resistance:=", "1.83566ohm", _
  "Inductance:=", "4.97468e-005H", "Voltage:=", _
  "424.578 * sin(2*pi*133.333*time+17.3128*pi/180-2*pi/3)", _
  "ParallelBranchesNum:=", "1")
Set oModule = oDesign.GetModule("BoundarySetup")
oModule.AssignWindingGroup Array("NAME:PhaseC", "Type:=", "Voltage", _
  "IsSolid:=", false, "Current:=", "0A", "Resistance:=", "1.83566ohm", _
  "Inductance:=", "4.97468e-005H", "Voltage:=", _
  "424.578 * sin(2*pi*133.333*time+17.3128*pi/180-4*pi/3)", _
  "ParallelBranchesNum:=", "1")
...
oModule.AssignBand Array("NAME:MotionSetup1", "Move Type:=", "Rotate", _
  ...
  "800rpm", "Moment of Inertia:=", 0.105289, "Damping:=", 0.0220164, _
  "Load Torque:=", _
  "if(speed<83.7758, -1.14048*speed, -8004.34/speed) - 1.14048*(speed-83.7758)*10", _
  "Objects:=", Array("Band"))
...
oModule.InsertSetup "Transient", Array("NAME:Setup1", "FastReachSteadyState:=", _
  true, "FrequencyOfAddedVoltageSource:=", "133.333Hz", "StopTime:=", _
  "0.014s", "TimeStep:=", "7e-005s")
Set oModule = oDesign.GetModule("BoundarySetup")
oModule.SetMinimumTimeStep "0.0007ms" 
